...
export class SuperDialogService {
  ...
  open<T>(obj: SuperDialogInterface) {
    ...
    setTimeout(() =>this.$open.next({component: obj.component, modalConfigurations: obj.modalConfigurations ? obj.modalConfigurations: {}, animations: obj.animations? obj.animations: {},  data: obj.data? obj.data: {}}), 300);
  }
}
